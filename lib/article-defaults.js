...
// Prewritten FAQ subheading for every new article. Editors can overwrite it, but
// starting with a sensible line saves them retyping the same sentence each time.
// Shared so the seed data and the "new article" stub stay in lockstep.
export const DEFAULT_FAQ_SUBHEADING =
