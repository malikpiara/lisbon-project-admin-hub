...
function CodeBlock({ code }: { code: string }) {
  return (
    <pre className="overflow-x-auto rounded-2xl bg-muted px-4 py-3 text-ds-xs leading-relaxed text-foreground">
      <code>{code}</code>
    </pre>
  );
}
...
function PreviewFrame({
  ...
  if (fullWidth) {
    return (
      <div className="overflow-x-auto rounded-[2rem] bg-bg-page ring-2 ring-border">
  ...
  return (
    <div className="rounded-[2rem] bg-card p-8 ring-2 ring-border">
      {children}
    </div>
  );
}
    ...
    <div className="grid min-w-0 gap-12 lg:grid-cols-[minmax(0,1fr)_14rem]">
      <article className="min-w-0 space-y-14">
        ...
        <DocBlock id="api-reference" title="API Reference">
          <div className="overflow-x-auto rounded-2xl ring-2 ring-border">
